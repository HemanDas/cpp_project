...
int main(){
    ...
    cin>>a>>b;
    c=a+b; // here '+' is an arithematic operator, other operator "+ , - , * , / , % , ++ , -- "
    cout<<"a="<<a<< endl;
    cout<<"b="<<b<<endl;
    ...
    if (a==b){                                    // here '==' is a relational operator, other operator "== , != , > , < , >= ,<=" 
    ...
    if ((a!=0)&&(a>=b)){                          // here '&&' is a Logical operator, other operator "&& , || , ! "
    ...
    cout<<"4)The bitwise AND(a&b)="<<(a&b)<<endl; // here '&' is a bitwise operator, other operator are "& , | , ^ , ~ , << , >> "

    // Conditional operator
    
    if (a>0){
        cout<<"5)a is positive."<<endl;
    }else{                                        // here 'if-else' is conditional operator.
    ...
    cout<<number<<endl;                           // here '? :' is ternary operator, used instead of if else.
